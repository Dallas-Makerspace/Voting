...
<?php echo $this->Form->create('Ballot');?>
	<fieldset>
		<legend><?php __('Admin Edit Ballot'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Ballot.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Ballot.id'))); ?></li>
